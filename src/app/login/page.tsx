...
export default function LoginPage() {
  ...
  return (
    <main className="site-shell flex min-h-screen items-center justify-center px-6 py-16">
      <div className="w-full max-w-md rounded-[2rem] border border-[#0a2348]/10 bg-white p-8 shadow-[0_24px_80px_rgba(10,35,72,.12)] sm:p-10">
        <p className="eyebrow text-[#0867d9]">Your ExpoStall account</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-xl bg-[#0867d9] px-4 py-3 font-semibold text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-[#0a2348] disabled:bg-slate-600"
          >
